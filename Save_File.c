            ...
            for (int i=3; i<= 14; i++){
                ...
                for (int j=1; j<=5; j++){
                    ...
                    switch(j){
                        ...
                        case 1:    fprintf(pFile, "%d;%s;%s;%s;%s;%s\n", i, Day, Dbs.Asist[i].Senin[1], Dbs.Asist[i].Senin[2],

                            Dbs.Asist[i].Senin[3], Dbs.Asist[i].Senin[4]);

                            break;



                         case 2:    fprintf(pFile, "%d;%s;%s;%s;%s;%s\n", i, Day, Dbs.Asist[i].Selasa[1], Dbs.Asist[i].Selasa[2],

                            Dbs.Asist[i].Selasa[3], Dbs.Asist[i].Selasa[4]);

                            break;



                         case 3:    fprintf(pFile, "%d;%s;%s;%s;%s;%s\n", i, Day, Dbs.Asist[i].Rabu[1], Dbs.Asist[i].Rabu[2],

                            Dbs.Asist[i].Rabu[3], Dbs.Asist[i].Rabu[4]);

                            break;



                          case 4:    fprintf(pFile, "%d;%s;%s;%s;%s;%s\n", i, Day, Dbs.Asist[i].Kamis[1], Dbs.Asist[i].Kamis[2],

                            Dbs.Asist[i].Kamis[3], Dbs.Asist[i].Kamis[4]);
                           ...
                           case 5:    fprintf(pFile, "%d;%s;%s;%s;%s;%s\n", i, Day, Dbs.Asist[i].Jumat[1], Dbs.Asist[i].Jumat[2],

                            Dbs.Asist[i].Jumat[3], Dbs.Asist[i].Jumat[4]);
